...
class DeviceProfile {
    ...
    DeviceProfile(Context context,
        ...
        searchBarSpaceHeightPx =  2 * edgeMarginPx;  // 去除搜索栏的高度
...
//            	Log.e("TAG1",isTablet()+"=======");
                ...
                // If the icon size changes across orientations, we will have to take
...
//                
//                Log.e("TAG1",desiredWorkspaceLeftRightMarginPx - defaultWidgetPadding.left
//                		+"   "+searchBarSpaceHeightPx);
//                Log.e("TAG2",desiredWorkspaceLeftRightMarginPx - defaultWidgetPadding.right+"   "+
//                		hotseatBarHeightPx + pageIndicatorHeightPx);
            }
        }
        return padding;
    ...
    public void layout(Launcher launcher) {
        ...
        if (hasVerticalBarLayout) {
            ...
            lp.height = searchBarSpaceHeightPx+searchBarHeightPx ;  // 之前去掉的搜索栏高度在这里面补上  
            searchBar.setPadding(
                    2 * edgeMarginPx,
                    2 * edgeMarginPx,
                    2 * edgeMarginPx, 0);
        ...
        if (voiceButtonProxy != null) {
            if (hasVerticalBarLayout) {
                // MOVE THIS INTO SEARCH BAR MEASURE
            } else {
...
public class DynamicGrid {
    ...
    public DynamicGrid(Context context, Resources resources,
        ...
        deviceProfiles.add(new DeviceProfile("Nexus S",
                296, 491.33f,  5, 4,  48, 13, (hasAA ? 5 : 4), 48));
        deviceProfiles.add(new DeviceProfile("Nexus 4",
                359, 518,  5, 4,  60, 13, (hasAA ? 5 : 4), 56));
