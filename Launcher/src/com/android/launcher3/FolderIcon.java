...
public class FolderIcon extends LinearLayout implements FolderListener {
    ...
    public static class FolderRingAnimator {
        ...
        public static int sPreviewPadding = -1;// -1
        ...
        public FolderRingAnimator(Launcher launcher, FolderIcon folderIcon) {
            ...
            if (sStaticValuesDirty) {
                ...
                sSharedOuterRingDrawable = res.getDrawable(R.drawable.icon_folder);//portal_ring_outer_holo
                sSharedInnerRingDrawable = res.getDrawable(R.drawable.icon_folder);//portal_ring_inner_nolip_holo
...
//        return params;
        ...
        if( PERSPECTIVE_SHIFT_FACTOR ==0.24f){
            ...
            if(0 <= index_order&&index_order < 3){ // 0 1 2 
                ...
                transY=mAvailableSpaceInPreview - (2*mBaselineIconSize + scaledSize +
                		scaleOffsetCorrection) + getPaddingTop()+0.2f*mBaselineIconSize;
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (!mAnimating) {
//        	for (int i = 0; i <= nItemsInPreview - 1; i++)  // 这个是要改的，当是没有什么的区别
